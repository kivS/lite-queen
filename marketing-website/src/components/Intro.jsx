...
export function Intro() {
	return (
		<>
			...
			<p className="mt-8 text-base/6 dark:text-gray-300 text-pretty text-center">
			...
			<div className="mt-10 flex flex-col flex-wrap justify-center gap-8  lg:justify-start">
...
function DemoButton() {
	return (
		<div className="flex flex-row  w-full gap-1 justify-center mb-4 dark:text-white ">
			{/* <FeaturesCarousel />
