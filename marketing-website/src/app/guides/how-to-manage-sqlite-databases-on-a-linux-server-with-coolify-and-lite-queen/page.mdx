...
{/* TODO: update the date once Coolify has released the update with Lite Queen added */}
**Update: As of Oct X 2024 you can now add Lite Queen with one click in your server with Coolify.**
...
4. Let's add a domain and connect it to our Lite Queen container
    ...
    - You can set the domain by going to the `Settings` in the service: 
      ...
      <img loading="lazy" src="https://media-files-go-brrr-project.kiv-d-dev.workers.dev/i/nhlp8w18l262nj4o78n2v8iywsbc"/>
    ...
    - Let's map our domain to the port 8000 in the Lite Queen container(port used by default). This is done by putting the domain, followed by a semicolon and then the port 8000.
      ...
      <img loading="lazy" src="https://media-files-go-brrr-project.kiv-d-dev.workers.dev/i/5x3sz2lntqz18qfyswgtojlfdl1k"/>
      {/* ![](https://media-files-go-brrr-project.kiv-d-dev.workers.dev/i/5x3sz2lntqz18qfyswgtojlfdl1k) */}
...
5. After saving and reloading the configuration(*Pull Latest Images & Restart* button), you should be able to see the initial screen of Lite Queen. Happy Hosting!
  ...
  <img loading="lazy" src="https://media-files-go-brrr-project.kiv-d-dev.workers.dev/i/6wv7b4dieid1mvrcnlj4810jye8a"/>
  
  {/* ![](https://media-files-go-brrr-project.kiv-d-dev.workers.dev/i/6wv7b4dieid1mvrcnlj4810jye8a) */}